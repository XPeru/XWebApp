angular.module('Ingreso').controller('modalIngresoController',  function ($scope, $http, $timeout, $uibModalInstance, selectedIngreso, IngresoServiceFactory, tipoIngresoList) {
	var ctrl = this;
